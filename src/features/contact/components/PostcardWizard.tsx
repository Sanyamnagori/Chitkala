                        ...
                        {current.key === "services" ? (
                          ...
                          <div className="mt-1">
                            ...
                            <textarea
                              ...
                              rows={2}
                              className="mt-0.5 w-full resize-none border-b border-deep-red/40 bg-transparent font-[family-name:var(--font-poppins)] text-[12px] text-deep-red/80 outline-none placeholder:text-deep-red/30 focus:border-deep-red md:text-[13px] transition-colors"
                            />
                          </div>
                        ) : (
                          <div className="mt-1">
                            ...
                            <input
                              ...
                              placeholder={current.placeholder}
                              className="mt-0.5 w-full border-b border-deep-red/40 bg-transparent font-[family-name:var(--font-poppins)] text-[12px] text-deep-red/80 outline-none placeholder:text-deep-red/30 focus:border-deep-red md:text-[13px] transition-colors"
                            />
                          </div>
                        )}
